...
(cl:in-package controller_calc-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <control_signal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control_signal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller_calc-msg:<control_signal> is deprecated: use controller_calc-msg:control_signal instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <control_signal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_calc-msg:header-val is deprecated.  Use controller_calc-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <control_signal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_calc-msg:accel-val is deprecated.  Use controller_calc-msg:accel instead.")
  (accel m))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <control_signal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_calc-msg:steer-val is deprecated.  Use controller_calc-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <control_signal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_calc-msg:status-val is deprecated.  Use controller_calc-msg:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<control_signal>)))
  ...
  "controller_calc/control_signal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'control_signal)))
  "Returns string type for a message object of type 'control_signal"
  "controller_calc/control_signal")
